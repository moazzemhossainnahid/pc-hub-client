...
const CourseContentForm = ({ handleCourseLessonsSubmit }) => {
  ...
  return (
    <div>
      ...
      >
        {/* <div className="">
          <label className="text-dark font-medium" for="lessons">
            Module Name
          </label>
          <input
            id="lesson"
      ...
      <div className="flex justify-end mt-12">
        <button
          onClick={() => {
            handleCourseLessonsSubmit(lessons), setLessons([]);
          }}
          type="submit"
          className="px-6 py-2 leading-5 text-white transition-colors duration-200 transform bg-secondary rounded hover:bg-accent font-medium focus:outline-none focus:bg-gray-600"
        >
          Ready to publish
        </button>
      </div>
